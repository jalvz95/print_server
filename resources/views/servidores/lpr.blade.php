...
@section('title', 'Servidor LPR/LPD')
...
<div x-data="simulacionApp()" x-init="init()">
    ...
    <div class="bg-orange-50 border-l-4 border-orange-400 p-4 mb-6 rounded">
        ...
        <a href="{{ route('tipo-servidor.index') }}" class="text-sm text-orange-600 hover:text-orange-800 mt-2 inline-block">← Volver a selección de tipos</a>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        ...
        <div id="packet-tracer" class="relative bg-gradient-to-br from-orange-50 to-amber-50 rounded-lg p-8 min-h-[500px] border-2 border-orange-200 overflow-hidden" data-impresoras='@json($impresoras)'>
