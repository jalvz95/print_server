...
@section('title', 'Servidor Dedicado (Hardware)')
...
<div x-data="simulacionApp()" x-init="init()">
    ...
    <div class="bg-green-50 border-l-4 border-green-400 p-4 mb-6 rounded">
        ...
        <a href="{{ route('tipo-servidor.index') }}" class="text-sm text-green-600 hover:text-green-800 mt-2 inline-block">← Volver a selección de tipos</a>
    </div>
