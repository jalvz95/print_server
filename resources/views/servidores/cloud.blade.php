...
<div x-data="simulacionApp()" x-init="init()">
    ...
    <div class="bg-cyan-50 border-l-4 border-cyan-400 p-4 mb-6 rounded">
        ...
        <a href="{{ route('tipo-servidor.index') }}" class="text-sm text-cyan-600 hover:text-cyan-800 mt-2 inline-block">← Volver a selección de tipos</a>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        ...
        <div class="mt-4 p-4 bg-cyan-50 rounded-lg">
