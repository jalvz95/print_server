...
class ServidorCloudController extends Controller
{
    /**
     * Dashboard para Servidor de Impresión en la Nube
     */
    public function index()
    {
        ...
        return view('servidores.cloud', compact('usuarios', 'trabajos', 'estadisticas'));
    }
}
