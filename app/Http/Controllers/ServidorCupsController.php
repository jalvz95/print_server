...
class ServidorCupsController extends Controller
{
    /**
     * Dashboard para Servidor CUPS (Common Unix Printing System)
     */
    public function index()
    {
        ...
        return view('servidores.cups', compact('usuarios', 'trabajos', 'estadisticas', 'impresoras'));
    }
}
