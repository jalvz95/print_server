...
class ServidorBasicoController extends Controller
{
    /**
     * Dashboard para Servidor de Impresión Básico
     */
    public function index()
    {
        ...
        return view('servidores.basico', compact('usuarios', 'trabajos', 'reglas', 'estadisticas'));
    }
}
