...
class ServidorIntegradoController extends Controller
{
    /**
     * Dashboard para Servidor de Impresión Integrado
     */
    public function index()
    {
        ...
        return view('servidores.integrado', compact('usuarios', 'trabajos', 'estadisticas'));
    }
}
