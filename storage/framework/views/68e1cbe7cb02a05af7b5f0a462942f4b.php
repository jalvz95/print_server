<?php $__env->startSection('title', 'Dashboard - Estadísticas'); ?>
...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="text-sm text-gray-500 sm:text-right">
                ...
                <p class="font-medium text-gray-700"><?php echo e(now()->format('d/m/Y H:i')); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-6 gap-4">
        <div class="bg-white rounded-lg shadow-sm p-5 flex flex-col justify-center">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($estadisticas['total_trabajos']); ?></p>
        ...
        <div class="bg-yellow-50 rounded-lg shadow-sm p-5 border border-yellow-200 flex flex-col justify-center">
            <div class="flex items-center gap-3">
                <span class="text-2xl">⏳</span>
                <div>
                    <p class="text-2xl font-bold text-yellow-700"><?php echo e($estadisticas['en_cola']); ?></p>
        ...
        <div class="bg-blue-50 rounded-lg shadow-sm p-5 border border-blue-200 flex flex-col justify-center">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-blue-700"><?php echo e($estadisticas['en_proceso']); ?></p>
        ...
        <div class="bg-red-50 rounded-lg shadow-sm p-5 border border-red-600 flex flex-col justify-center">
            <div class="flex items-center gap-3">
                <span class="text-2xl">🚫</span>
                <div>
                    <p class="text-2xl font-bold text-red-700"><?php echo e($estadisticas['bloqueados']); ?></p>
        ...
        <div class="bg-green-50 rounded-lg shadow-sm p-5 border border-green-200 flex flex-col justify-center">
            <div class="flex items-center gap-3">
                <span class="text-2xl">✅</span>
                <div>
                    <p class="text-2xl font-bold text-green-700"><?php echo e($estadisticas['terminados']); ?></p>
        ...
        <div class="bg-purple-50 rounded-lg shadow-sm p-5 border border-purple-200 flex flex-col justify-center">
            <div class="flex items-center gap-3">
                <span class="text-2xl">📑</span>
                <div>
                    <p class="text-2xl font-bold text-purple-700"><?php echo e(number_format($totalPaginas)); ?></p>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-lg shadow-sm p-5">
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <p class="text-xl font-bold text-gray-900"><?php echo e($impresorasStats['total']); ?></p>
                    <p class="text-xs text-gray-500">Impresoras</p>
                    <p class="text-xs text-green-600 font-medium"><?php echo e($impresorasStats['funcionales']); ?> funcionales</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-5">
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <p class="text-xl font-bold text-gray-900"><?php echo e($usuarios->count()); ?></p>
                    <p class="text-xs text-gray-500">Usuarios</p>
                    <p class="text-xs text-blue-600 font-medium"><?php echo e($usuarios->where('activo', true)->count()); ?> activos</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-5">
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <p class="text-xl font-bold text-gray-900"><?php echo e($reglasStats['total']); ?></p>
                    <p class="text-xs text-gray-500">Reglas</p>
                    <p class="text-xs text-amber-600 font-medium"><?php echo e($reglasStats['activas']); ?> activas</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-5">
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <p class="text-xl font-bold text-gray-900"><?php echo e(number_format($tiempoPromedioSegundos, 1)); ?>s</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $ultimosTrabajos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trabajo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-3 text-sm text-gray-900 whitespace-nowrap"><?php echo e($trabajo->usuario->nombre ?? 'N/A'); ?></td>
                            <td class="px-6 py-3 text-sm text-gray-600 max-w-[180px] truncate"><?php echo e($trabajo->descripcion); ?></td>
                            <td class="px-4 py-3 text-sm text-gray-900 text-center"><?php echo e($trabajo->paginas); ?></td>
                            <td class="px-4 py-3 text-center">
                                ...
                                ?>
                                <span class="inline-flex px-2 py-1 text-xs font-medium rounded-full <?php echo e($estadoClasses); ?>">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="p-4">
                <div class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $usuarios->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <div class="flex items-center gap-3 min-w-0">
                            ...
                            <div class="min-w-0">
                                <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($usuario->nombre); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($usuario->trabajos_count); ?> trabajos</p>
                            </div>
                        </div>
                        <div class="text-right flex-shrink-0 ml-4">
                            ...
                            ?>
                            <p class="text-lg font-bold <?php echo e($cuotaClass); ?>"><?php echo e($usuario->cuota_actual); ?></p>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <?php $__currentLoopData = $motivosBloqueo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $motivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-start gap-3 p-4 bg-red-50 border border-red-100 rounded-lg">
                    <span class="text-red-500 flex-shrink-0">🚫</span>
                    <div class="min-w-0">
                        <p class="text-sm text-red-800 break-words"><?php echo e($motivo->motivo_bloqueo); ?></p>
                        <p class="text-xs text-red-500 mt-1"><?php echo e($motivo->total); ?> ocurrencias</p>
                    </div>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <?php $__empty_1 = true; $__currentLoopData = $impresoras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $impresora): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                ?>
                <div class="p-4 rounded-lg border <?php echo e($cardClasses); ?>">
                    <div class="flex items-center justify-between mb-3">
                        <h4 class="font-medium text-gray-900 truncate pr-2"><?php echo e($impresora->nombre); ?></h4>
                        <span class="text-xl flex-shrink-0"><?php echo e($impresora->icono_estado); ?></span>
                    </div>
                    <div class="space-y-1 text-sm">
                        <p class="text-gray-600">Estado: <span class="font-medium capitalize"><?php echo e(str_replace('_', ' ', $impresora->estado)); ?></span></p>
                        <p class="text-gray-600">Trabajos: <span class="font-medium"><?php echo e($impresora->trabajos_count); ?></span></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<script id="chart-data" type="application/json"><?php echo json_encode($chartData); ?></script>
<script>
