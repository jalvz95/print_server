<?php $__env->startSection('title', 'Servidor Basado en Software'); ?>
...
<div x-data="simulacionApp()" x-init="init()">
    ...
    <div class="bg-purple-50 border-l-4 border-purple-400 p-4 mb-6 rounded">
        ...
        <a href="<?php echo e(route('tipo-servidor.index')); ?>" class="text-sm text-purple-600 hover:text-purple-800 mt-2 inline-block">← Volver a selección de tipos</a>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/servidores/software.blade.php ENDPATH**/ ?>