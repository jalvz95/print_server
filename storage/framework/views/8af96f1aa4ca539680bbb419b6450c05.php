            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    <div class="flex-shrink-0 flex items-center">
                        <a href="<?php echo e(route('tipo-servidor.index')); ?>" class="text-2xl font-bold text-gray-800 hover:text-gray-600 transition-colors cursor-pointer">
                            🖨️ Print Server
                        </a>
                    </div>
                    <div class="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-8">
                        <!-- Link al Dashboard -->
                        <a x-show="!quickNavVisible" href="<?php echo e(route('dashboard')); ?>"
                        ...
                        <div x-show="quickNavVisible"
                            ...
                            <a href="<?php echo e(route('servidor.basico')); ?>" class="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-blue-50 border border-transparent hover:bg-blue-100 hover:border-blue-400 hover:text-blue-700 transition">
                            ...
                            <a href="<?php echo e(route('servidor.cups-backend')); ?>" class="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-indigo-50 border border-transparent hover:bg-indigo-100 hover:border-indigo-400 hover:text-indigo-700 transition">
                                <span class="text-lg">📊</span>
                                <span>CUPS Flow</span>
                            </a>
