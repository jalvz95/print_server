...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-blue-400">
        ...
        <!-- Servidor CUPS -->
        <a href="<?php echo e(route('servidor.cups')); ?>" class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-indigo-400">
            <div class="text-center">
                <div class="text-5xl mb-4">🐧</div>
        ...
        <!-- Servidor LPR/LPD -->
        <a href="<?php echo e(route('servidor.lpr')); ?>" class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-amber-400">
            <div class="text-center">
                <div class="text-5xl mb-4">📠</div>
